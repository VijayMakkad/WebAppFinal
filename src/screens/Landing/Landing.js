...
export default function Landing() {
  ...
  const heading1 = splitter('One Stop Shop')
  const heading2 = splitter('For Indias Gold Need')
  const ideology = splitter('Ideology')
  const why = splitter('Why Gold') 
  const whyHeading = splitter('Here is a key reason to invest in gold')
  const charvariants = {
    hidden: { opacity: 0 },
    reveal: { opacity: 1 }
  }
            ...
            <div className="landing">
                ...
                <div className="landingrow d-flex flex-column justify-content-start flex-md-row pt-5">
                  <div className="d-flex flex-column col-12 align-items-center justify-content-start col-md-6 align-items-md-start justify-content-md-center">
                    <div className="heading d-flex flex-column justify-content-center align-items-center align-items-md-start justify-content-md-center" >
                      <motion.h1 id='onestop' initial='hidden' whileInView='reveal' transition={{staggerChildren:.02}}>{heading1.map(char=>(
                        <motion.span
                      ...
                      <motion.h1 id='india' initial='hidden' whileInView='reveal' transition={{staggerChildren:.02}}>{heading2.map(char=>(
                        <motion.span
              ...
              <section id="two">
                <div className="text-row">
                      <motion.h1 id='ideology' initial='hidden' whileInView='reveal' transition={{staggerChildren:.02}}>{ideology.map(char=>(
                        <motion.span
                          key={char}
                          transition={{ duration: 0.5, ease: 'easeOut' }}
                          variants={charvariants}
              ...
              <section id="three">
                <div className="d-flex flex-column justify-content-evenly row-gap-3 align-items-center" style={{height:'100vh'}}>                  
                  <div className="text-row d-flex flex-row col-sm-12 justify-content-center" >
                          <motion.h1 id='WhyGold' initial='hidden' whileInView='reveal' transition={{staggerChildren:.02}}>{why.map(char=>(
                            <motion.span
                              key={char}
                              transition={{ duration: 0.5, ease: 'easeOut' }}
                              variants={charvariants}
                  ...
                  <div className="w-100 h-100 d-flex flex-column-reverse flex-md-row">
                    <div className="d-flex flex-column col-md-5 align-items-start justify-content-center h-100">
                      <div>                        
                        <motion.h1 id='HeadingWhyGold' initial='hidden' whileInView='reveal' transition={{staggerChildren:.02}}>{whyHeading.map(char=>(
                          <motion.span
                            key={char}
                            transition={{ duration: 0.5, ease: 'easeOut' }}
                            variants={charvariants}
